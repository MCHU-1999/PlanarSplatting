...
def predict_mono_geo_demo(color_images, color_intrinsics, depth_save_dir, normal_save_dir, model_type='metric3d_vit_large'):
    """
    ...
    for i, (rgb_origin, intrinsic_matrix) in enumerate(zip(color_images, color_intrinsics)):
        ...
        # save depth
        save_path = os.path.join(depth_save_dir, f'{i+1:06d}.png')
        pred_depth[pred_depth > 10] = 0.
        save_npy_path = save_path.replace('.png', '.npy')
        ...
        # save normals
        save_path = os.path.join(normal_save_dir, f'{i+1:06d}.png')
        save_npy_path = save_path.replace('.png', '.npy')
